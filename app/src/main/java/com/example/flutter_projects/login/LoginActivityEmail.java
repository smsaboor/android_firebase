...
import com.example.flutter_projects.MainActivityEmail;
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email) && TextUtils.isEmpty(password)) {
                    Toast.makeText(LoginActivityEmail.this, "Please enter your credentials..", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivityEmail.this, "Login Successful..", Toast.LENGTH_SHORT).show();
                            //on below line we are opening our mainactivity.
                            Intent i = new Intent(LoginActivityEmail.this, MainActivityEmail.class);
                            startActivity(i);
                            finish();
                        } else {
                            //hiding our progress bar and displaying a toast message.
                            loadingPB.setVisibility(View.GONE);
                            Toast.makeText(LoginActivityEmail.this, "Please enter valid user credentials..", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
