...
public class MainActivityEmail extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCourseFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivityEmail.this, AddCourseActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.idLogOut){
            ...
            Intent i = new Intent(MainActivityEmail.this, LoginActivityEmail.class);
            startActivity(i);
            this.finish();
            return true;
        }else{
    ...
    private void displayBottomSheet(CourseRVModal modal) {
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivityEmail.this, EditCourseActivity.class);
